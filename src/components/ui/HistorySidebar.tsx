...
type Props = {
  onChoiceCallback: (type: string) => void;
    ...
    >
      ...
      <motion.div className="flex flex-col space-y-4">
        <motion.div variants={linkVariants}>
          <Button
            onClick={() => handleChoice("CONTRACTED")}
            variant="linkUnderline"
            size="linkUnderline"
            className={
              currentActive === "CONTRACTED"
        ...
        <motion.div variants={linkVariants}>
          <Button
            onClick={() => handleChoice("SHARING")}
            variant="linkUnderline"
            size="linkUnderline"
            className={
              currentActive === "SHARING"
                ? "text-primary font-semibold underline"
                : ""
            }
          >
