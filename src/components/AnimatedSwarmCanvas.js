...
export const AnimatedSwarmCanvas = () => (
  <div
    style={{
      width: 900,
      height: 700,
  ...
  >
    ...
    >
      ...
      {/* <directionalLight position={[0, 0, 5000]} intensity={5} color="#1c3556" /> */}
      <pointLight distance={60} intensity={5} color="#1c3556" />

      <spotLight
        intensity={5} // Stronger light
        position={[20, 20, 20]} // Closer to the scene
        angle={Math.PI / 4} // Wider spread
        penumbra={0.5} // Soft edges
        color="#ffffff" // Brighter neutral light (or "#1c3556" if you want blue tint)
        castShadow // Enable shadows if needed
      />
      <mesh>
        <planeGeometry args={[1000, 1000]} />
        <meshStandardMaterial color="white" roughness={0.5} depthTest={false} />
      </mesh>
      <Swarm count={20000} />
      <Postpro />
    </Canvas>
